    ...
    public partial class SettingModelFactory : ISettingModelFactory
    {
        ...
        protected virtual async Task<DisplayDefaultFooterItemSettingsModel> PrepareDisplayDefaultFooterItemSettingsModelAsync()
        {
            ...
            var model = new DisplayDefaultFooterItemSettingsModel
            {
                ...
                DisplayApplySellerAccountFooterItem = displayDefaultFooterItemSettings.DisplayApplySellerAccountFooterItem
            };
            ...
            model.DisplayApplySellerAccountFooterItem_OverrideForStore = await _settingService.SettingExistsAsync(displayDefaultFooterItemSettings, x => x.DisplayApplySellerAccountFooterItem, storeId);
        ...
        public virtual async Task<VendorSettingsModel> PrepareVendorSettingsModelAsync(VendorSettingsModel model = null)
        {
            ...
            if (storeId > 0)
            {
                ...
                model.AllowCustomersToApplyForSellerAccount_OverrideForStore = await _settingService.SettingExistsAsync(vendorSettings, x => x.AllowCustomersToApplyForSellerAccount, storeId);
