...
namespace Nop.Web.Areas.Admin.Models.Catalog
{
        ...
        IAclSupportedModel, IDiscountSupportedModel, ILocalizedModel<ProductLocalizedModel>, IStoreMappingSupportedModel
    {
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.HasEMIAvailable")]
        public bool HasEMIAvailable { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.InterestRate")]
        public decimal InterestRate { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.DownPaymentPercent")]
