...
namespace Nop.Web.Areas.Admin.Infrastructure.Mapper
{
    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        protected virtual void CreateVendorLocationMaps()
        {
            CreateMap<NkVendorLocation, NkVendorLocationModel>();
            CreateMap<NkVendorLocationModel, NkVendorLocation>();
