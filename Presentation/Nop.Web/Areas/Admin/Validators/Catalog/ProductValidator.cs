    ...
    public partial class ProductValidator : BaseNopValidator<ProductModel>
    {
        public ProductValidator(ILocalizationService localizationService, INopDataProvider dataProvider)
        {
            ...
            RuleFor(x => x.DownPaymentPercent)
                ...
                .WithMessageAwait(localizationService.GetResourceAsync("Admin.Catalog.Products.Fields.DownPaymentPercent.ShouldBeGreaterThanZeroAndLessThanHundred"));

            RuleFor(x => x.InterestRate)
              
               .LessThanOrEqualTo(25)
               .WithMessageAwait(localizationService.GetResourceAsync("Admin.Catalog.Products.Fields.DownPaymentPercent.ShouldBeGreaterThanZeroAndLessThanTwentyFive"));
